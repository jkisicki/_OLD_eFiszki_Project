...
namespace efiszkiProject
{
    ...
    /// </summary>
    public sealed partial class DodajSlowko : Page
    {
        public string aktualnabaza;
        public DodajSlowko()
        {
            this.InitializeComponent();
            aktualnabaza = DodajBaze.baza;
            buttonDodajSlowko.IsEnabled = false;
            DodajSlowkoEndButton.IsEnabled = false;
        ...
        private void DodajSlowkoEndButton_Click(object sender, RoutedEventArgs e)
        {
